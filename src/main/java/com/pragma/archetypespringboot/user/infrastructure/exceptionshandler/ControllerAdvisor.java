...
public class ControllerAdvisor {
    ...
    @ExceptionHandler(InvalidUserDateBirthException.class)
    public ResponseEntity<Map<String,String>> handlerInvalidUserDateBirthException(InvalidUserDateBirthException exception){
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(Collections.singletonMap(MESSAGE, UserExceptionConstant.INVALID_USER_DATE_BIRTH_MESSAGE));
    }
